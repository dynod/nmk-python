...
Moreover, it overrides the [${venvUpdateInput}](https://nmk-base.readthedocs.io/en/stable/config.html#venvupdateinput) item, to condition the venv refresh on the **pyproject.toml** file, rather than on the **requirements.txt** one.
